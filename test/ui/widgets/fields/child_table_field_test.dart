...
void main() {
  ...
  testWidgets('tapping row on readOnly field opens read-only sheet with Close button', (
    tester,
  ) async {
    final readField = DocField(
      fieldname: 'items',
    ...
    await _pump(
      ...
      formBuilder: (meta, initialData, onSubmit, {registerSubmit, bool readOnly = false}) {
